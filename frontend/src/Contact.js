  ...
  const contactInfo = [
    {
      ...
      details: ['477, Veehul Finserve LLP, 4th Cross, Shanmuga Nagar, UKT Malai, ', 'Trichy-620102', 'India']
    },
    {
      icon: '📞',
      title: 'Call Us',
      details: ['+91 7010895123', 'Mon-Sat: 9:00 AM - 6:00 PM']
    },
    {
      icon: '✉️',
      title: 'Email Us',
      details: ['support@veehul.com', 'Quick response within 24 hours']
    }
  ];
            ...
            <div className="contact-sidebar">
                ...
                <ul className="benefits-list">
                  ...
                  <li>
                    ...
                    <div>
                      ...
                      <p>Helping clients achieve financial success since 2016</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="sidebar-card cta-card">
                ...
                <div className="cta-buttons">
                  <a href="tel:+917010895123" className="cta-phone">📞 Call Now</a>
                </div>
              </div>
            </div>
          </div>
